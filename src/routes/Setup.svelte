...
<Screen ignoreAuth>
  <div class="row">
    <div class="col-12">
      <Card>
        <p class="text-title">Welcome to Kesplora!</p>
        <p>You are seeing this screen because this is a fresh installation of Kesplora. <strong>If you were not expecting to see this, this client is not configured properly or the API cannot connect to an existing installation.</strong> If that is the case, refer to the documentation for setting up and configuring both the server and the client.</p>

        <p>To get started, we need some information about your site. You will find the Site Code in the output of the API server when it began. You will need to provide that in the form below. You will need to provide information for all of the fields in order to move on. Importantly, the Administrator Information will create the administrator account for this platform, so please ensure that information is correct.</p>
      </Card>
    </div>
  </div>
      ...
      <Card title="Site Configuration">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <MarkdownEditor bind:content={description} mode="edit" />
          </div>
        </div>
      </Card>
    </div>
